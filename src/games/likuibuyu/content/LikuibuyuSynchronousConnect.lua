...
local LikuibuyuSynchronousConnect = class("LikuibuyuSynchronousConnect",BaseConnect)
...
LikuibuyuSynchronousConnect.port = Port.PORT_LIKUIBUYU
LikuibuyuSynchronousConnect.type = cmd.SUB_S_SYNCHRONOUS

function LikuibuyuSynchronousConnect:ctor(callback)
	self.callback = callback
end

function LikuibuyuSynchronousConnect:writeData(data)
end
...
return LikuibuyuSynchronousConnect