...
local LikuibuyuDelayBeginCreateConnect = class("LikuibuyuDelayBeginCreateConnect",BaseConnect)
...
LikuibuyuDelayBeginCreateConnect.port = Port.PORT_LIKUIBUYU
LikuibuyuDelayBeginCreateConnect.type = cmd.SUB_S_DELAY_BEGIN

function LikuibuyuDelayBeginCreateConnect:ctor(callback)
	self.callback = callback
end

function LikuibuyuDelayBeginCreateConnect:writeData(data)
end

function LikuibuyuDelayBeginCreateConnect:readData(data)
...
return LikuibuyuDelayBeginCreateConnect