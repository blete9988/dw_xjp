...
local LikuibuyuDelayConnect = class("LikuibuyuDelayConnect",BaseConnect)
...
LikuibuyuDelayConnect.port = Port.PORT_LIKUIBUYU
LikuibuyuDelayConnect.type = cmd.SUB_S_DELAY

function LikuibuyuDelayConnect:ctor(callback)
	self.callback = callback
end

function LikuibuyuDelayConnect:writeData(data)
end
