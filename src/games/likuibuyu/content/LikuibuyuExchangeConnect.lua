...
local LikuibuyuExchangeConnect = class("LikuibuyuExchangeConnect",BaseConnect)
...
LikuibuyuExchangeConnect.port = Port.PORT_LIKUIBUYU
LikuibuyuExchangeConnect.type = cmd.SUB_S_EXCHANGE_SCENE

function LikuibuyuExchangeConnect:ctor(callback)
	self.callback = callback
end

function LikuibuyuExchangeConnect:writeData(data)
end

function LikuibuyuExchangeConnect:readData(data)
	mlog("李逵捕鱼切换场景收到数据返回！")
...
return LikuibuyuExchangeConnect