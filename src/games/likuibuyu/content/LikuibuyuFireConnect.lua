...
local LikuibuyuFireConnect = class("LikuibuyuFireConnect",BaseConnect)
...
LikuibuyuFireConnect.port = Port.PORT_LIKUIBUYU
LikuibuyuFireConnect.type = cmd.SUB_S_FIRE

function LikuibuyuFireConnect:ctor(callback)
	self.callback = callback
end

function LikuibuyuFireConnect:writeData(data)
end
