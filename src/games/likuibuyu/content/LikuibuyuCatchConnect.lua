...
local LikuibuyuCatchConnect = class("LikuibuyuCatchConnect",BaseConnect)
...
LikuibuyuCatchConnect.port = Port.PORT_LIKUIBUYU
LikuibuyuCatchConnect.type = cmd.SUB_S_FISH_CATCH

function LikuibuyuCatchConnect:ctor(callback)
	self.callback = callback
end

function LikuibuyuCatchConnect:writeData(data)
end
