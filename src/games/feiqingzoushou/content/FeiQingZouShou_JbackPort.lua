...
local FeiQingZouShou_JbackPort = {}
function FeiQingZouShou_JbackPort.extend(data)
	local player = Player
	local dataController = require("src.games.feiqingzoushou.data.FeiQingZouShouDataController").getInstance()
	local handler = function(data)
		local tp = data:readUnsignedShort()
		mlog(string.format("<FeiQingZouShou_JbackPort> receive JBack message , type = %s",tp))
...
return FeiQingZouShou_JbackPort
