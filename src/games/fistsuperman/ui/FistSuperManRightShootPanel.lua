...
local FistSuperManRightShootPanel = class("FistSuperManRightShootPanel",function() return display.newImage("gwj_ui_bg_3.png") end,require("src.base.event.EventDispatch"))
...
function FistSuperManRightShootPanel:ctor()
...
function FistSuperManRightShootPanel:show()
	if self.state then
		self:moveGo()
	else
		self:moveTo()
...
function FistSuperManRightShootPanel:moveTo()
...
function FistSuperManRightShootPanel:moveGo()
...
return FistSuperManRightShootPanel
