...
local FistSuperManLeftShootPanel = class("FistSuperManLeftShootPanel",function() return display.newImage("gwj_ui_bg_1.png") end,require("src.base.event.EventDispatch"))
...
function FistSuperManLeftShootPanel:ctor()
...
function FistSuperManLeftShootPanel:show()
	if self.state then
		self:moveGo()
	else
		self:moveTo()
...
function FistSuperManLeftShootPanel:moveTo()
...
function FistSuperManLeftShootPanel:moveGo()
...
return FistSuperManLeftShootPanel
