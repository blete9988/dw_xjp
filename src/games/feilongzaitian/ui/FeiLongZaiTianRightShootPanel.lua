...
local FeiLongZaiTianRightShootPanel = class("FeiLongZaiTianRightShootPanel",function() return display.newImage("gwj_ui_bg_3.png") end,require("src.base.event.EventDispatch"))
...
function FeiLongZaiTianRightShootPanel:ctor()
...
function FeiLongZaiTianRightShootPanel:show()
	if self.state then
		self:moveGo()
	else
		self:moveTo()
...
function FeiLongZaiTianRightShootPanel:moveTo()
...
function FeiLongZaiTianRightShootPanel:moveGo()
...
return FeiLongZaiTianRightShootPanel
