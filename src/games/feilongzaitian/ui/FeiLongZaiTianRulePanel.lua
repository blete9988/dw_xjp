...
function FeiQingZouShouRulePanel:ctor()
	local main_layout = display.newImage("#game/feilongzaitian/flzt_rule_bg.png")
    ...
    local content_imgI = display.newDynamicImage("game/feilongzaitian/flzt_rule_2.png")
    content_imgI:setAnchorPoint(cc.p(0,0))
    content_imgI:setPosition(cc.p(23,0))
    photo_scroll:addChild(content_imgI)

    local content_imgII = display.newDynamicImage("game/feilongzaitian/flzt_rule_1.png")
    ...
    local scroll_height = content_imgI:getContentSize().height + content_imgII:getContentSize().height
...
function FeiQingZouShouRulePanel.show()
	local ranle = FeiQingZouShouRulePanel.new()
