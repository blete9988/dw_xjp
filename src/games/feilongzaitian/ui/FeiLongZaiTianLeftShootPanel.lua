...
local FeiLongZaiTianLeftShootPanel = class("FeiLongZaiTianLeftShootPanel",function() return display.newImage("gwj_ui_bg_1.png") end,require("src.base.event.EventDispatch"))
...
function FeiLongZaiTianLeftShootPanel:ctor()
...
function FeiLongZaiTianLeftShootPanel:show()
	if self.state then
		self:moveGo()
	else
		self:moveTo()
...
function FeiLongZaiTianLeftShootPanel:moveTo()
...
function FeiLongZaiTianLeftShootPanel:moveGo()
...
return FeiLongZaiTianLeftShootPanel
