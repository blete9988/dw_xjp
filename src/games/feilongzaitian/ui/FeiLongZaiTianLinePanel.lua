...
local FeiLongZaiTianLinePanel = class("FeiLongZaiTianLinePanel",function() 
	local layout = display.extend("CCLayerExtend",display.newLayout())
	return layout
end,require("src.base.event.EventDispatch"))

function FeiLongZaiTianLinePanel:ctor(lineList)
...
--轮流显示
function FeiLongZaiTianLinePanel:takeTurns()
...
return FeiLongZaiTianLinePanel
